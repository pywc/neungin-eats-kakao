...
function getmeal($days)
{
  ...
  $URL = "https://stu.dge.go.kr/sts_sci_md01_001.do?schulCode=D100000277&&schulCrseScCode=2&schMmealScCode=2&schYmd=" . $date; // DOMDocument
  // url 생성
  ...
  $final=str_replace('남)', '', $final);  // br => 개행
